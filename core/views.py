            ...
            if result is not None:
                ...
                if payment_status is not None:
                    ...
                    try:
                        ...
                        sms = f"Congratulations {poster_name}! Your item '{item_name}' has been ordered by {buyer_name}. Raddi Bazaar Team will pick up the item from the provided address within 7-10 working days and pay you ₹{item_price} at time of pickup. Regards from Raddi Bazaar Pvt. Ltd!"
